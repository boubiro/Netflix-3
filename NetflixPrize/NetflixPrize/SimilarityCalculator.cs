...
namespace NetflixPrize
{
	...
	{		
		public static int CalculateForUser(int user1, int user2)
		{
			...
			return Calculate(intersect.Count, filteredUser1Reviews, filteredUser2Reviews);	
		}
		...
		public static int CalculateForMovie(int movie1, int movie2)
		{
			...
			return Calculate(count, filteredMovie1Reviews, filteredMovie2Reviews);
		}
		
		private int Calculate(int totalCount, Review[] uno, Review[] dos, int meanUno, int meanDos)
		{
			int sum;
